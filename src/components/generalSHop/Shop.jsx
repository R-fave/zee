...
const Shop = () => {
  ...
  return (
    <div class=" bg-gradient-to-b from-[#FFFCFB] to-[#FBCDBD]">
      <div class=" my-6 px-28 md:max-lg:px-10 max-sm:px-2">
        <p>
          Home /<span class=" font-bold"> Shop</span>
        </p>
      </div>

      <div class=" px-28 md:max-lg:px-10 max-sm:px-2">
      ...
      <div class=" bg-bg-desk bg-cover text-white text-center flex justify-end items-center gap-5 flex-col h-[600px] mt-10 max-sm:bg-bg-mobile">
      ...
      <div class=" flex flex-wrap gap-x-48 gap-y-14 justify-center py-20 px-18 md:max-lg:px-10 md:max-lg:gap-x-10 max-sm:gap-x-5 max-sm:gap-y-5">
