...
const Footer = () => {
  return (
    <div class=" bg-[#171717] text-white px-28 py-14">
      <div class=" flex flex-col justify-center items-center gap-5 mb-14">
        <p class=" font-bold text-2xl">JOIN OUR EMAIL LIST</p>
      ...
      <hr />
      <div class=" flex justify-evenly mt-20 text-[12px] font-extralight">
      ...
      <div class=" flex justify-between mt-14">
        <div class=" flex gap-5 text-sm font-extralight">
          <button class=" border border-[#FF9F3D] px-3 py-1 text-[#FF9F3D]">
            Cookie Preference
          </button>
          <p>Privacy Policy</p>
          <p>Terms Of Use</p>
        ...
        <img src={social} alt="Social Media" class=" h-[20px]" />
      </div>
    </div>
  );
};
